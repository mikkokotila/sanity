def effect_check():
    ...
    '''Sanity checking of effectiveness for programmatic media investments.
    Creates a visual slider based emulator with parameter ranges based on
    a robust programmatic market model.

    NOTE: you have to run this on a Jupyter notebook. Otherwise, will not work.
